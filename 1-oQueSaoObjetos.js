// objeto é uma estrutura de dados composta por chave e valor que permite organizar informações 
// de uma abstração de objetos do mundo real, por exemplo: uma pessoa, um carro, uma conta corrente, etc... 
